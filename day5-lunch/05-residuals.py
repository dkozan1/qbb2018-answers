...
"""
Usage: ./05.residuals.py <<tab> <tab> <tab> <tab> <tab>> <original ctab file>
Plot the residuals of your model and evaluate to evaluate this 
assumption with regard to your data
"""
